...
func TestHandshake(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			cfg:  baseCfg,
			steps: []step{
				{in: ":irc.test 433 * AlteredParadox :Nickname is already in use", want: []string{"NICK AlteredParado1"}},
		...
		},
		{
			...
			cfg:  baseCfg,
			steps: []step{
				{in: ":irc.test 433 * AlteredParadox :in use", want: []string{"NICK AlteredParado1"}},
				{in: ":irc.test 433 * AlteredParado1 :in use", want: []string{"NICK AlteredParado2"}},
				{in: ":irc.test 433 * AlteredParado2 :in use", want: []string{"NICK AlteredParado3"}},
				{in: ":irc.test 433 * AlteredParado3 :in use", errSub: "all fallbacks"},
			},
		},
		{
